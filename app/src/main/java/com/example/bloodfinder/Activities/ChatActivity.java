...
import com.example.bloodfinder.Model.Recentchatmodel;
...
//        DatabaseReference dbref = FirebaseDatabase.getInstance().getReference("Favourites").child(mAuth.getCurrentUser().getUid());
