...
import com.example.bloodfinder.Fragments.HomeFragment;
...
////                            }
////                        }, 800);
//                        Toast.makeText(Dashboard.this, "Achievement", Toast.LENGTH_SHORT).show();
//                        break;
                    case R.id.infoPage:
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                startActivity(new Intent(Dashboard.this, BloodInformation.class));
                            }
                        }, 800);
                        break;
                    case R.id.aboutUs:
...
//        progressDialog.setCancelable(false);
        final ProgressDialog mDialog = new ProgressDialog(Dashboard.this);
