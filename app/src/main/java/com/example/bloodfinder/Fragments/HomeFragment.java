...
import com.example.bloodfinder.Activities.UserViewHospital;
import com.example.bloodfinder.Activities.ViewEvent;
...
public class HomeFragment extends Fragment {
    ...
    CardView cardviewFindBlood, donateBlood, availableBlood, cadrViewReminder, cardViewHospital, cardViewEvent;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       // FirebaseOffline.getSync();
        ...
        cardViewHospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), UserViewHospital.class));
            }
        });
        cardViewEvent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), ViewEvent.class));
            }
        });
    }
    ...
    private void initViews(View view) {
        ...
        cardViewHospital = view.findViewById(R.id.cardViewRegisterHospital);
        cardViewEvent = view.findViewById(R.id.cardviewAllEvents);
